...
def upload_overlay(login, password, overlay_file, api_url, project_id):
    ...
    # Before adding an overlay in MINERVA, data overlay file must be uploaded to the instance (MANUAL: https://minerva.pages.uni.lu/doc/api/14.0/files/)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='An example of MINERVA API calls uploading overlays')
